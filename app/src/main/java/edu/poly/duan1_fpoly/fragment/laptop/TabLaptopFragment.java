...
public class TabLaptopFragment extends Fragment {
    private RecyclerView recyclerView;
    private SanPhamAdapter sanPhamAdapter;
    private SanPhamDao sanPhamDao;

    public static TabLaptopFragment newInstance() {
        TabLaptopFragment fragment = new TabLaptopFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tab_laptop, container, false);
    }
    ...
    private void initView(View view) {
        ...
        sanPhamDao.getSanPham(getContext(), Server.LinkSanPhamTheLoai, getHashMap(), sanPhamAdapter);
