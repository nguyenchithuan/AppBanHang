...
public class TabLaptopNewFragment extends Fragment {
    private RecyclerView recyclerView;
    private SanPhamAdapter sanPhamAdapter;
    private SanPhamDao sanPhamDao;


    public static TabLaptopNewFragment newInstance() {
        TabLaptopNewFragment fragment = new TabLaptopNewFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tab_laptop_new, container, false);
    }
