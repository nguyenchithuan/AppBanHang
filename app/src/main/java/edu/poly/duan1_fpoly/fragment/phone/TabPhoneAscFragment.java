...
public class TabPhoneAscFragment extends Fragment {
    private RecyclerView recyclerView;
    private SanPhamAdapter sanPhamAdapter;
    private SanPhamDao sanPhamDao;

    public static TabPhoneAscFragment newInstance() {
        TabPhoneAscFragment fragment = new TabPhoneAscFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tag_phone_asc, container, false);
    }
    ...
    private HashMap<String, String> getHashMap() {
        ...
        hashMap.put("idsanpham", "1"); // 1 phone
        hashMap.put("sapxep", "1"); // 1 giảm
        return hashMap;
    }
}